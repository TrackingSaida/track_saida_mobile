...
export default function ScanScreen({ navigation }: Props) {
  ...
  const styles = useMemo(
    () =>
      StyleSheet.create({
        ...
        backText: { fontSize: 16, lineHeight: 22, color: colors.primary, marginBottom: 8 },
        backTextWhite: { fontSize: 15, lineHeight: 20, color: "#fff", marginBottom: 4, fontWeight: "600" },
        title: { fontSize: 22, lineHeight: 28, fontWeight: "700", color: colors.text },
        titleWhite: { fontSize: 20, lineHeight: 26, fontWeight: "700", color: "#fff" },
        subtitle: { fontSize: 14, lineHeight: 19, color: colors.textSecondary, marginTop: 4 },
        subtitleWhite: { fontSize: 13, lineHeight: 18, color: "rgba(255,255,255,0.85)", marginTop: 2 },
        input: {
        ...
        contadorNum: { fontSize: 18, lineHeight: 22, fontWeight: "700", color: "#fff" },
        contadorLabel: { fontSize: 11, lineHeight: 14, color: "rgba(255,255,255,0.95)", textAlign: "center" },
        btnComecarEntregar: {
          backgroundColor: colors.primary,
          paddingVertical: 14,
          minHeight: 48,
        ...
        verListaText: { color: "#fff", fontSize: 13, lineHeight: 18 },
        secondaryActionsRow: {
          flexDirection: "row",
          flexWrap: "wrap",
          gap: 8,
        ...
        listaItemCodigo: { color: "#fff", fontSize: 14, lineHeight: 19, fontWeight: "600", flexShrink: 1 },
        servicoBadge: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
        servicoBadgeText: { color: "#fff", fontSize: 12, lineHeight: 16, fontWeight: "600" },
        btnRemover: {
          paddingVertical: 6,
          paddingHorizontal: 12,
          minHeight: 32,
        ...
        btnRemoverText: { color: "#fff", fontSize: 13, lineHeight: 17, fontWeight: "600" },
        modalOverlay: {
          flex: 1,
          backgroundColor: colors.overlay,
          justifyContent: "center",
  ...
  }, [feedbackVisual, feedbackColors, insets.top, insets.bottom]);
